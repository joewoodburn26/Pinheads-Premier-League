...
export function SiteHeader({ seasons, activeSeason, teams }: { seasons: Season[]; activeSeason?: Season; teams: Team[] }) {
  return (
      ...
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="ml-auto flex flex-wrap items-center justify-end gap-2 text-sm">
          ...
          <div className="group relative">
            ...
            <div className="invisible absolute right-0 top-9 w-56 rounded-md border bg-card p-1 opacity-0 shadow-glow transition group-hover:visible group-hover:opacity-100">
              {teams.map((team) => (
